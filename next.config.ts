...
/**
 * Security headers + CSP for Sollos 3.
 *
...
// Only apply Sentry's build wrapper when a DSN is set. Without it, the
// wrapper becomes a no-op pass-through, so shipping this line is safe.
