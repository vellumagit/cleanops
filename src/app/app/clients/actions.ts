...
function readFormValues(formData: FormData) {
  return {
    ...
    lead_note: String(formData.get("lead_note") ?? ""),
    preferred_contact: String(formData.get("preferred_contact") ?? "email"),
    contact_preference: String(formData.get("contact_preference") ?? "inherit"),
