  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex flex-wrap items-center gap-2">
        ...
        {/* A paid run is a record of money that left the business — the
            action refuses to delete it, so don't offer to. */}
        {run.status !== "paid" ? (
          <form
          ...
          <p className="ml-auto text-[11px] text-muted-foreground">
            Paid runs are permanent records and can&rsquo;t be deleted.
          </p>
        )}
      </div>
    </PageShell>
