 ...
 *
 * Billing CTAs (links to /app/settings/billing) are only shown to
 * owners and admins — those are the only roles that can actually
 * access that page. Other roles see the informational message only.
 */
      ...
      <div className="mx-auto flex max-w-screen-xl items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <p>
            ...
            {canManageBilling
              ? "You can still view your data, but creating new bookings, invoices, and estimates is disabled until you subscribe."
              : "Creating new records is disabled. Ask your workspace owner to renew the subscription."}
          </p>
        </div>
        {canManageBilling && (
          <Link
